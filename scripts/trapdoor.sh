...
echo "\"block.colouredstuff.${seed}_black\" : \"Black Wooden Trapdoor\","
...
do
  ...
  # echo "$color"
   ...
   # blockstate      
	...
	# block model  
	cp "${folder}"/models/block/trapdoor/"${input}"_black_top.json "${folder}"/models/block/trapdoor/"${input}"_"${color}"_top.json
	sed -i -e "s/black/${color}/g" "${folder}"/models/block/trapdoor/"${input}"_"${color}"_top.json
	
	cp "${folder}"/models/block/trapdoor/"${input}"_black_bottom.json "${folder}"/models/block/trapdoor/"${input}"_"${color}"_bottom.json
	sed -i -e "s/black/${color}/g" "${folder}"/models/block/trapdoor/"${input}"_"${color}"_bottom.json
	 
	cp "${folder}"/models/block/trapdoor/"${input}"_black_open.json "${folder}"/models/block/trapdoor/"${input}"_"${color}"_open.json
	sed -i -e "s/black/${color}/g" "${folder}"/models/block/trapdoor/"${input}"_"${color}"_open.json
   ...
   #recipe
	...
	echo "\"block.colouredstuff.${seed}_${color}\" : \"${name} Wooden Trapdoor\","
