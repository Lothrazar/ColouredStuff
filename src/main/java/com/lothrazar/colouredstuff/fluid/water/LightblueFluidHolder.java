...
public class LightblueFluidHolder extends InfiniteFluidHolder {

  private static final String COLOUR = "light_blue";
  ...
  public static DeferredHolder<Block, LiquidBlock> BLOCK = ColourableBlockRegistry.BLOCKS.registerBlock(ID + "_block", props -> new ColourLiquidBlock(STILL,
      props.mapColor(DyeColor.LIGHT_BLUE), DyeColorless.LIGHT_BLUE), InfiniteFluidHolder::blockProps);
