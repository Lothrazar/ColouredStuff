...
public class PurpleFluidHolder extends InfiniteFluidHolder {

  private static final String COLOUR = "purple";
  ...
  public static DeferredHolder<Block, LiquidBlock> BLOCK = ColourableBlockRegistry.BLOCKS.registerBlock(ID + "_block", props -> new ColourLiquidBlock(STILL,
      props.mapColor(DyeColor.PURPLE), DyeColorless.PURPLE), InfiniteFluidHolder::blockProps);
