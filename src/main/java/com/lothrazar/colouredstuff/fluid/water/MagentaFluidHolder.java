...
public class MagentaFluidHolder extends InfiniteFluidHolder {

  private static final String COLOUR = "magenta";
  ...
  public static DeferredHolder<Block, LiquidBlock> BLOCK = ColourableBlockRegistry.BLOCKS.registerBlock(ID + "_block", props -> new ColourLiquidBlock(STILL,
      props.mapColor(DyeColor.MAGENTA), DyeColorless.MAGENTA), InfiniteFluidHolder::blockProps);
