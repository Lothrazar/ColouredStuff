...
public class LightgrayFluidHolder extends InfiniteFluidHolder {

  private static final String COLOUR = "light_gray";
  ...
  public static DeferredHolder<Block, LiquidBlock> BLOCK = ColourableBlockRegistry.BLOCKS.registerBlock(ID + "_block", props -> new ColourLiquidBlock(STILL,
      props.mapColor(DyeColor.LIGHT_GRAY), DyeColorless.LIGHT_GRAY), InfiniteFluidHolder::blockProps);
