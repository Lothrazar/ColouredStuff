...
public class LimeBoat extends Boat {
  ...
  public LimeBoat(Level level, double x, double y, double z) {
    super(ColourableItemRegistry.BOAT_ENTITY_LIME.get(), level);
    this.setPos(x, y, z);
  ...
  public LimeBoat(SpawnEntity spawnEntity, Level level) {
    this(ColourableItemRegistry.BOAT_ENTITY_LIME.get(), level);
  }
