...
public class YellowBoat extends Boat {
  ...
  public YellowBoat(Level level, double x, double y, double z) {
    super(ColourableItemRegistry.BOAT_ENTITY_YELLOW.get(), level);
    this.setPos(x, y, z);
  ...
  public YellowBoat(SpawnEntity spawnEntity, Level level) {
    this(ColourableItemRegistry.BOAT_ENTITY_YELLOW.get(), level);
  }
  ...
  public Item getDropItem() {
    return ColourableItemRegistry.BOAT_YELLOW.get();
  }
}
