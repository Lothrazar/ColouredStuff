...
public class BlueBoat extends Boat {
  ...
  public BlueBoat(Level level, double x, double y, double z) {
    super(ColourableItemRegistry.BOAT_ENTITY_BLUE.get(), level);
    this.setPos(x, y, z);
  ...
  public BlueBoat(SpawnEntity spawnEntity, Level level) {
    this(ColourableItemRegistry.BOAT_ENTITY_BLUE.get(), level);
  }
  ...
  public Item getDropItem() {
    return ColourableItemRegistry.BOAT_BLUE.get();
  }
