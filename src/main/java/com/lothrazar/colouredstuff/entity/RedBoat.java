...
public class RedBoat extends Boat {
  ...
  public RedBoat(Level level, double x, double y, double z) {
    super(ColourableItemRegistry.BOAT_ENTITY_RED.get(), level);
    this.setPos(x, y, z);
  ...
  public RedBoat(SpawnEntity spawnEntity, Level level) {
    this(ColourableItemRegistry.BOAT_ENTITY_RED.get(), level);
  }
