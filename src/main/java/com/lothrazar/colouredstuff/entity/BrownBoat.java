...
public class BrownBoat extends Boat {
  ...
  public BrownBoat(Level level, double x, double y, double z) {
    super(ColourableItemRegistry.BOAT_ENTITY_BROWN.get(), level);
    this.setPos(x, y, z);
  ...
  public BrownBoat(SpawnEntity spawnEntity, Level level) {
    this(ColourableItemRegistry.BOAT_ENTITY_BROWN.get(), level);
  }
  ...
  public Item getDropItem() {
    return ColourableItemRegistry.BOAT_BROWN.get();
  }
}
