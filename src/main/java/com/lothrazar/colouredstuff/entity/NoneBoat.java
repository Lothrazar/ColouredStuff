...
public class NoneBoat extends Boat {
  ...
  public NoneBoat(Level level, double x, double y, double z) {
    super(ColourableItemRegistry.BOAT_ENTITY_NONE.get(), level);
    this.setPos(x, y, z);
  ...
  public NoneBoat(SpawnEntity spawnEntity, Level level) {
    this(ColourableItemRegistry.BOAT_ENTITY_NONE.get(), level);
  }
  ...
  public Item getDropItem() {
    return ColourableItemRegistry.BOAT_NONE.get();
  }
}
