...
public class CobblestoneStair extends StairBlock implements IHasColor {

  private static Map<DyeColorless, Block> RAINBOW = new HashMap<>();
  private final DyeColorless color;

  //pass in the base block
  public CobblestoneStair(java.util.function.Supplier<BlockState> state, Properties p, DyeColorless color) {
    super(state, p);
